...
pub use runtime_common::{
	opaque, AccountId, AuraId, Balance, BlockNumber, CrossAccountId, Hash, Header, Index,
	Signature, EvmAddressMapping, EvmBackwardsAddressMapping, AVERAGE_ON_INITIALIZE_RATIO, DAYS,
	MINUTES, EVM_DISPATCH_RATIO, MAXIMUM_BLOCK_WEIGHT, NORMAL_DISPATCH_RATIO, SLOT_DURATION,
};
...
/// scheduled fairly
const EVM_DISPATCH_RATIO: Perbill = Perbill::from_percent(50); TODO delete*/
parameter_types! {
...
impl pallet_common::Config for Runtime {
	type Event = Event;
	type EvmBackwardsAddressMapping = EvmBackwardsAddressMapping; // up_evm_mapping::MapBackwardsAddressTruncated;
	type EvmAddressMapping = EvmAddressMapping; // HashedAddressMapping<Self::Hashing>;
	type CrossAccountId = CrossAccountId; // pallet_common::account::BasicCrossAccountId<Self>;
