...
use frame_support::traits::{Currency as CurrencyT, Everything, OnUnbalanced as OnUnbalancedT};
use frame_support::weights::{WeightToFee, WeightToFeeCoefficient, WeightToFeeCoefficients, WeightToFeePolynomial};
...
use xcm::prelude::{Concrete, Fungible as XcmFungible};
use xcm::v1::{BodyId, Junction::{Parachain, Plurality}, Junctions::*, MultiLocation, NetworkId};
use xcm_builder::{AccountId32Aliases, AllowTopLevelPaidExecutionFrom, AllowUnpaidExecutionFrom, CurrencyAdapter, FixedWeightBounds, LocationInverter, NativeAsset, ParentAsSuperuser, ParentIsPreset, RelayChainAsNative, SiblingParachainAsNative, SiblingParachainConvertsVia, SignedAccountId32AsNative, SignedToAccountId32, SovereignSignedViaLocation, TakeWeightCredit};
use xcm_executor::{Assets, Config};
use xcm_executor::traits::{MatchesFungible, WeightTrader};

use unique_runtime_common::{constants::{MAXIMUM_BLOCK_WEIGHT, UNIQUE}, types::{AccountId, Balance}};

use crate::LinearFee;

use super::constructor::{Balances, Call, Origin, ParachainInfo, ParachainSystem, PolkadotXcm, XcmpQueue};
...
impl<
    ...
    OnUnbalanced: OnUnbalancedT<Currency::NegativeImbalance>,
>
Drop for UsingOnlySelfCurrencyComponents<WeightToFee, AssetId, AccountId, Currency, OnUnbalanced>
{
    fn drop(&mut self) {
...
impl Config for XcmConfig {
    ...
    type Trader = UsingOnlySelfCurrencyComponents<
        LinearFee<Balance>, RelayLocation, AccountId, Balances, ()
    >;
