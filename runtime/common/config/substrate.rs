...
use crate::{
	runtime_common::DealWithFees, Balances, Block, ForeignAssets, Fungible, OriginCaller,
	PalletInfo, Runtime, RuntimeCall, RuntimeEvent, RuntimeFreezeReason, RuntimeHoldReason,
	RuntimeOrigin, RuntimeTask, SS58Prefix, System, Treasury, Version,
};
...
pub type ForeignAssetsFungibles = pallet_fungible::FrameFungiblesAdapter<
	staging_xcm::v5::Location,
	CurrencyIdConvert<ForeignAssets>,
	Fungible,
>;

pub struct ResolveToTreasury;
impl HandleCredit<AccountId, ForeignAssetsFungibles> for ResolveToTreasury {
	fn handle_credit(credit: fungibles::Credit<AccountId, ForeignAssetsFungibles>) {
		// Best effort
		let _ = ForeignAssetsFungibles::resolve(&TreasuryAccount::get(), credit);
	}
}

pub type AssetTxFeeFungiblesAdapter =
	pallet_asset_tx_payment::FungiblesAdapter<ForeignAssets, ResolveToTreasury>;

impl pallet_asset_tx_payment::Config for Runtime {
	type Fungibles = ForeignAssetsFungibles;
	type OnChargeAssetTransaction = AssetTxFeeFungiblesAdapter;
	type RuntimeEvent = RuntimeEvent;
