	...
	() => {
		frame_support::construct_runtime! {
				...
				UncheckedExtrinsic = UncheckedExtrinsic
			{
                ...
                #[cfg(feature = "governance")]
                Fellowship: pallet_collective::<Instance2> = 44,

                #[cfg(feature = "governance")]
                TechnicalCommittee: pallet_collective::<Instance3> = 45,

                #[cfg(feature = "governance")]
                CouncilMembership: pallet_membership::<Instance1> = 46,

                #[cfg(feature = "governance")]
                FellowshipMembership: pallet_membership::<Instance2> = 47,

                #[cfg(feature = "governance")]
                TechnicalCommitteeMembership: pallet_membership::<Instance3> = 48,

                #[cfg(feature = "governance")]
                GovScheduler: pallet_scheduler = 49,
