...
(async () => {
  ...
  await Promise.all([
    ...
    ff('wss://polkadot-asset-hub-rpc.polkadot.io/', /^(....)$/, 'release-parachains-v$1').then(v => env = setVar(env, 'ASSET_HUB_POLKADOT_BUILD_BRANCH', v)),
    ...
    ff('wss://kusama-asset-hub-rpc.polkadot.io/', /^(....)$/, 'release-parachains-v$1').then(v => env = setVar(env, 'ASSET_HUB_KUSAMA_BUILD_BRANCH', v)),
