...
declare module '@polkadot/types/types/registry' {
  interface InterfaceTypes {
    ...
    OpalRuntimeRuntimeCommonFeeCoefficientCalculator: OpalRuntimeRuntimeCommonFeeCoefficientCalculator;
