...
declare module '@polkadot/types/types/registry' {
  interface InterfaceTypes {
    ...
    PalletTemplateTransactionPaymentCheckNonce: PalletTemplateTransactionPaymentCheckNonce;
