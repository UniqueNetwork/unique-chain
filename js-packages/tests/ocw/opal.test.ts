...
export const ALICE_ORCL_KEY = process.env.RELAY_OPAL_NODE_ALICE_ORCL_KEY;
export const BOB_ORCL_KEY = process.env.RELAY_OPAL_NODE_BOB_ORCL_KEY;
export const CHARLIE_ORCL_KEY = process.env.RELAY_OPAL_NODE_CHARLIE_ORCL_KEY;
