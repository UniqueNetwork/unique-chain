...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	/// Storage: `Configuration::RelayBlockNumberChecks` (r:0 w:1)
	/// Proof: `Configuration::RelayBlockNumberChecks` (`max_values`: Some(1), `max_size`: Some(1), added: 496, mode: `MaxEncodedLen`)
	fn set_relay_block_number_checks() -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `0`
		//  Estimated: `0`
