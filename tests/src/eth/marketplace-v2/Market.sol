...
contract Market is Ownable, ReentrancyGuard {
	...
	CollectionHelpers private constant collectionHelpers = CollectionHelpers(0x6C4E9fE1AE37a41E93CEE429e8E1881aBdcbb54F);
	...
	event TokenIsPurchased(uint32 version, Order item, uint32 salesAmount, CrossAddress buyer, RoyaltyAmount[] royalties);
	...
	function put(
		...
		Order memory order = Order(0, collectionId, tokenId, amount, price, seller);
