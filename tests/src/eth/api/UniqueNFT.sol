...
interface Collection is Dummy, ERC165 {
	...
	function setCollectionSponsorCross(Tuple8 memory sponsor) external;
	...
	function addCollectionAdminCross(Tuple8 memory newAdmin) external;

	/// Remove collection admin.
	/// @param admin Cross account administrator address.
	/// @dev EVM selector for this function is: 0x6c0cd173,
	///  or in textual repr: removeCollectionAdminCross((address,uint256))
	function removeCollectionAdminCross(Tuple8 memory admin) external;
	...
	function addToCollectionAllowListCross(Tuple8 memory user) external;
	...
	function removeFromCollectionAllowListCross(Tuple8 memory user) external;
	...
	function isOwnerOrAdminCross(Tuple8 memory user) external view returns (bool);
...
interface ERC721UniqueExtensions is Dummy, ERC165 {
	...
	function approveCross(Tuple8 memory approved, uint256 tokenId) external;
	...
	function burnFromCross(Tuple8 memory from, uint256 tokenId) external;
