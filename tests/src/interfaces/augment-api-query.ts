...
declare module '@polkadot/api-base/types/storage' {
  interface AugmentedQueries<ApiType extends ApiTypes> {
    ...
    configuration: {
      ...
      governanceConfigurationOverride: AugmentedQuery<ApiType, () => Observable<PalletConfigurationGovernanceConfiguration>, []> & QueryableStorageEntry<ApiType, []>;
