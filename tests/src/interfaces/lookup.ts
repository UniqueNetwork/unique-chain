...
export default {
  ...
  /**
   * Lookup258: pallet_maintenance::pallet::Call<T>
   **/
  ...
  /**
   * Lookup261: sp_runtime::DispatchError
   **/
  ...
  /**
   * Lookup262: sp_runtime::ModuleError
   **/
  ...
  /**
   * Lookup264: sp_runtime::ArithmeticError
   **/
  SpRuntimeArithmeticError: {
    _enum: ['Underflow', 'Overflow', 'DivisionByZero']
  },
  /**
   * Lookup265: sp_runtime::TransactionalError
   **/
  SpRuntimeTransactionalError: {
    _enum: ['LimitReached', 'NoLayer']
  },
  /**
   * Lookup266: pallet_sudo::pallet::Error<T>
   **/
  PalletSudoError: {
    _enum: ['RequireSudo']
  },
  /**
   * Lookup267: frame_system::AccountInfo<Index, pallet_balances::AccountData<Balance>>
   **/
  ...
  /**
   * Lookup268: frame_support::weights::PerDispatchClass<T>
   **/
  ...
  /**
   * Lookup269: sp_runtime::generic::digest::Digest
   **/
  SpRuntimeDigest: {
    logs: 'Vec<SpRuntimeDigestDigestItem>'
  },
  /**
   * Lookup271: sp_runtime::generic::digest::DigestItem
   **/
  ...
  /**
   * Lookup273: frame_system::EventRecord<opal_runtime::Event, primitive_types::H256>
   **/
  ...
  /**
   * Lookup275: frame_system::pallet::Event<T>
   **/
  FrameSystemEvent: {
    _enum: {
      ExtrinsicSuccess: {
  ...
  /**
   * Lookup276: frame_support::weights::DispatchInfo
   **/
  ...
  /**
   * Lookup277: frame_support::weights::DispatchClass
   **/
  FrameSupportWeightsDispatchClass: {
    _enum: ['Normal', 'Operational', 'Mandatory']
  },
  /**
   * Lookup278: frame_support::weights::Pays
   **/
  FrameSupportWeightsPays: {
    _enum: ['Yes', 'No']
  },
  /**
   * Lookup279: orml_vesting::module::Event<T>
   **/
  ...
  /**
   * Lookup280: cumulus_pallet_xcmp_queue::pallet::Event<T>
   **/
  ...
  /**
   * Lookup281: pallet_xcm::pallet::Event<T>
   **/
  PalletXcmEvent: {
    _enum: {
  ...
  /**
   * Lookup282: xcm::v2::traits::Outcome
   **/
  XcmV2TraitsOutcome: {
    _enum: {
      Complete: 'u64',
  ...
  /**
   * Lookup284: cumulus_pallet_xcm::pallet::Event<T>
   **/
  ...
  /**
   * Lookup285: cumulus_pallet_dmp_queue::pallet::Event<T>
   **/
  ...
  /**
   * Lookup286: pallet_unique::RawEvent<sp_core::crypto::AccountId32, pallet_evm::account::BasicCrossAccountIdRepr<sp_core::crypto::AccountId32>>
   **/
  ...
  /**
   * Lookup287: pallet_unique_scheduler::pallet::Event<T>
   **/
  ...
  /**
   * Lookup289: frame_support::traits::schedule::LookupError
   **/
  FrameSupportScheduleLookupError: {
    _enum: ['Unknown', 'BadFormat']
  },
  /**
   * Lookup290: pallet_common::pallet::Event<T>
   **/
  PalletCommonEvent: {
    _enum: {
  ...
  /**
   * Lookup291: pallet_structure::pallet::Event<T>
   **/
  ...
  /**
   * Lookup292: pallet_rmrk_core::pallet::Event<T>
   **/
  PalletRmrkCoreEvent: {
    _enum: {
      CollectionCreated: {
  ...
  /**
   * Lookup293: pallet_rmrk_equip::pallet::Event<T>
   **/
  ...
  /**
   * Lookup294: pallet_evm::pallet::Event<T>
   **/
  PalletEvmEvent: {
    _enum: {
      Log: 'EthereumLog',
  ...
  /**
   * Lookup296: pallet_ethereum::pallet::Event
   **/
  PalletEthereumEvent: {
    _enum: {
  ...
  /**
   * Lookup297: evm_core::error::ExitReason
   **/
  ...
  /**
   * Lookup298: evm_core::error::ExitSucceed
   **/
  EvmCoreErrorExitSucceed: {
    _enum: ['Stopped', 'Returned', 'Suicided']
  },
  /**
   * Lookup299: evm_core::error::ExitError
   **/
  ...
  /**
   * Lookup304: pallet_maintenance::pallet::Event<T>
   **/
  ...
  /**
   * Lookup313: frame_support::weights::PerDispatchClass<T>
   **/
  ...
  /**
   * Lookup314: frame_support::weights::RuntimeDbWeight
   **/
  ...
  /**
   * Lookup321: orml_vesting::module::Error<T>
   **/
  ...
  /**
   * Lookup365: up_data_structs::PropertiesMap<up_data_structs::PropertyPermission>
   **/
  ...
  /**
   * Lookup429: pallet_maintenance::pallet::Error<T>
   **/
  ...
  /**
   * Lookup432: sp_core::ed25519::Signature
   **/
  ...
  /**
   * Lookup444: opal_runtime::CheckMaintenance
   **/
