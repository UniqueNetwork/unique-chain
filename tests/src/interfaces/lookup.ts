...
export default {
  ...
  /**
   * Lookup180: pallet_unq_scheduler::Call<T>
   **/
  ...
  /**
   * Lookup182: pallet_template_transaction_payment::Call<T>
   **/
  PalletTemplateTransactionPaymentCall: 'Null',
  /**
   * Lookup183: pallet_evm::pallet::Call<T>
   **/
  PalletEvmCall: {
    _enum: {
      withdraw: {
  ...
  /**
   * Lookup189: pallet_ethereum::pallet::Call<T>
   **/
  PalletEthereumCall: {
    _enum: {
      transact: {
  ...
  /**
   * Lookup190: ethereum::transaction::TransactionV2
   **/
  ...
  /**
   * Lookup191: ethereum::transaction::LegacyTransaction
   **/
  ...
  /**
   * Lookup192: ethereum::transaction::TransactionAction
   **/
  ...
  /**
   * Lookup193: ethereum::transaction::TransactionSignature
   **/
  ...
  /**
   * Lookup195: ethereum::transaction::EIP2930Transaction
   **/
  ...
  /**
   * Lookup197: ethereum::transaction::AccessListItem
   **/
  ...
  /**
   * Lookup198: ethereum::transaction::EIP1559Transaction
   **/
  ...
  /**
   * Lookup199: pallet_evm_migration::pallet::Call<T>
   **/
  ...
  /**
   * Lookup202: pallet_sudo::pallet::Event<T>
   **/
  PalletSudoEvent: {
    _enum: {
      Sudid: {
  ...
  /**
   * Lookup204: sp_runtime::DispatchError
   **/
  ...
  /**
   * Lookup228: pallet_unq_scheduler::RawEvent<BlockNumber>
   **/
  PalletUnqSchedulerRawEvent: {
    _enum: {
      Scheduled: '(u32,u32)',
      Canceled: '(u32,u32)',
  ...
  /**
   * Lookup230: pallet_common::pallet::Event<T>
   **/
  PalletCommonEvent: {
    _enum: {
  ...
  /**
   * Lookup231: pallet_evm::pallet::Event<T>
   **/
  PalletEvmEvent: {
    _enum: {
      Log: 'EthereumLog',
  ...
  /**
   * Lookup233: pallet_ethereum::pallet::Event
   **/
  PalletEthereumEvent: {
    _enum: {
  ...
  /**
   * Lookup234: evm_core::error::ExitReason
   **/
  ...
  /**
   * Lookup235: evm_core::error::ExitSucceed
   **/
  EvmCoreErrorExitSucceed: {
    _enum: ['Stopped', 'Returned', 'Suicided']
  },
  /**
   * Lookup236: evm_core::error::ExitError
   **/
  ...
  /**
   * Lookup239: evm_core::error::ExitRevert
   **/
  EvmCoreErrorExitRevert: {
    _enum: ['Reverted']
  },
  /**
   * Lookup240: evm_core::error::ExitFatal
   **/
  ...
  /**
   * Lookup243: frame_system::LastRuntimeUpgradeInfo
   **/
  ...
  /**
   * Lookup244: frame_system::limits::BlockWeights
   **/
  ...
  /**
   * Lookup245: frame_support::weights::PerDispatchClass<frame_system::limits::WeightsPerClass>
   **/
  ...
  /**
   * Lookup246: frame_system::limits::WeightsPerClass
   **/
  ...
  /**
   * Lookup249: frame_support::weights::PerDispatchClass<T>
   **/
  ...
  /**
   * Lookup250: frame_support::weights::RuntimeDbWeight
   **/
  ...
  /**
   * Lookup255: frame_system::pallet::Error<T>
   **/
  FrameSystemError: {
    _enum: ['InvalidSpecName', 'SpecVersionNeedsToIncrease', 'FailedToExtractRuntimeVersion', 'NonDefaultComposite', 'NonZeroRefCount', 'CallFiltered']
  },
  /**
   * Lookup257: orml_vesting::module::Error<T>
   **/
  OrmlVestingModuleError: {
    _enum: ['ZeroVestingPeriod', 'ZeroVestingPeriodCount', 'InsufficientBalanceToLock', 'TooManyVestingSchedules', 'AmountLow', 'MaxVestingSchedulesExceeded']
  },
  /**
   * Lookup259: cumulus_pallet_xcmp_queue::InboundChannelDetails
   **/
  ...
  /**
   * Lookup260: cumulus_pallet_xcmp_queue::InboundState
   **/
  CumulusPalletXcmpQueueInboundState: {
    _enum: ['Ok', 'Suspended']
  },
  /**
   * Lookup263: polkadot_parachain::primitives::XcmpMessageFormat
   **/
  PolkadotParachainPrimitivesXcmpMessageFormat: {
    _enum: ['ConcatenatedVersionedXcm', 'ConcatenatedEncodedBlob', 'Signals']
  },
  /**
   * Lookup266: cumulus_pallet_xcmp_queue::OutboundChannelDetails
   **/
  ...
  /**
   * Lookup267: cumulus_pallet_xcmp_queue::OutboundState
   **/
  CumulusPalletXcmpQueueOutboundState: {
    _enum: ['Ok', 'Suspended']
  },
  /**
   * Lookup269: cumulus_pallet_xcmp_queue::QueueConfigData
   **/
  ...
  /**
   * Lookup271: cumulus_pallet_xcmp_queue::pallet::Error<T>
   **/
  CumulusPalletXcmpQueueError: {
    _enum: ['FailedToSend', 'BadXcmOrigin', 'BadXcm', 'BadOverweightIndex', 'WeightOverLimit']
  },
  /**
   * Lookup272: pallet_xcm::pallet::Error<T>
   **/
  PalletXcmError: {
    _enum: ['Unreachable', 'SendFailure', 'Filtered', 'UnweighableMessage', 'DestinationNotInvertible', 'Empty', 'CannotReanchor', 'TooManyAssets', 'InvalidOrigin', 'BadVersion', 'BadLocation', 'NoSubscription', 'AlreadySubscribed']
  },
  /**
   * Lookup273: cumulus_pallet_xcm::pallet::Error<T>
   **/
  CumulusPalletXcmError: 'Null',
  /**
   * Lookup274: cumulus_pallet_dmp_queue::ConfigData
   **/
  CumulusPalletDmpQueueConfigData: {
    maxIndividual: 'u64'
  },
  /**
   * Lookup275: cumulus_pallet_dmp_queue::PageIndexData
   **/
  ...
  /**
   * Lookup278: cumulus_pallet_dmp_queue::pallet::Error<T>
   **/
  CumulusPalletDmpQueueError: {
    _enum: ['Unknown', 'OverLimit']
  },
  /**
   * Lookup282: pallet_unique::Error<T>
   **/
  PalletUniqueError: {
    _enum: ['CollectionDecimalPointLimitExceeded', 'ConfirmUnsetSponsorFail', 'EmptyArgument']
  },
  /**
   * Lookup285: pallet_unq_scheduler::Scheduled<unique_runtime::Call, BlockNumber, unique_runtime::OriginCaller, sp_core::crypto::AccountId32, unique_runtime::SchedulerPreDispatch>
   **/
  PalletUnqSchedulerScheduled: {
    maybeId: 'Option<Bytes>',
    priority: 'u8',
    call: 'Call',
    maybePeriodic: 'Option<(u32,u32)>',
    origin: 'UniqueRuntimeOriginCaller',
    preDispatch: 'UniqueRuntimeSchedulerPreDispatch'
  },
  /**
   * Lookup286: unique_runtime::OriginCaller
   **/
  ...
  /**
   * Lookup287: frame_system::RawOrigin<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup288: pallet_xcm::pallet::Origin
   **/
  PalletXcmOrigin: {
    _enum: {
  ...
  /**
   * Lookup289: cumulus_pallet_xcm::pallet::Origin
   **/
  ...
  /**
   * Lookup290: pallet_ethereum::RawOrigin
   **/
  ...
  SpCoreVoid: 'Null',
  /**
   * Lookup292: unique_runtime::SchedulerPreDispatch
   **/
  UniqueRuntimeSchedulerPreDispatch: {
    tip: 'u128',
    signer: 'AccountId32',
    fee: 'Option<u128>'
  },
  /**
   * Lookup293: pallet_unq_scheduler::Error<T>
   **/
  ...
  /**
   * Lookup307: pallet_nonfungible::ItemData<pallet_common::account::BasicCrossAccountIdRepr<sp_core::crypto::AccountId32>>
   **/
  ...
  /**
   * Lookup347: pallet_template_transaction_payment::ChargeTransactionPayment<unique_runtime::Runtime>
   **/
  PalletTemplateTransactionPaymentChargeTransactionPayment: 'Compact<u128>',
  /**
   * Lookup348: unique_runtime::Runtime
   **/
