...
declare module '@polkadot/types/lookup' {
  ...
  /** @name PalletUnqSchedulerCall (180) */
  ...
  /** @name PalletTemplateTransactionPaymentCall (182) */
  export type PalletTemplateTransactionPaymentCall = Null;

  /** @name PalletEvmCall (183) */
  ...
  /** @name EthereumTransactionTransactionV2 (190) */
  ...
  /** @name EthereumTransactionLegacyTransaction (191) */
  ...
  /** @name EthereumTransactionTransactionAction (192) */
  ...
  /** @name EthereumTransactionTransactionSignature (193) */
  ...
  /** @name EthereumTransactionEip2930Transaction (195) */
  ...
  /** @name EthereumTransactionAccessListItem (197) */
  export interface EthereumTransactionAccessListItem extends Struct {
    readonly address: H160;
    readonly slots: Vec<H256>;
  }

  /** @name EthereumTransactionEip1559Transaction (198) */
  ...
  /** @name PalletEvmMigrationCall (199) */
  ...
  /** @name SpRuntimeDispatchError (204) */
  ...
  /** @name PalletUnqSchedulerRawEvent (228) */
  export interface PalletUnqSchedulerRawEvent extends Enum {
  ...
  /** @name EvmCoreErrorExitReason (234) */
  ...
  /** @name EvmCoreErrorExitSucceed (235) */
  ...
  /** @name EvmCoreErrorExitError (236) */
  ...
  /** @name EvmCoreErrorExitRevert (239) */
  export interface EvmCoreErrorExitRevert extends Enum {
    readonly isReverted: boolean;
    readonly type: 'Reverted';
  }

  /** @name EvmCoreErrorExitFatal (240) */
  ...
  /** @name FrameSystemLimitsBlockWeights (244) */
  ...
  /** @name FrameSupportWeightsPerDispatchClassWeightsPerClass (245) */
  ...
  /** @name FrameSystemLimitsWeightsPerClass (246) */
  ...
  /** @name FrameSupportWeightsPerDispatchClassU32 (249) */
  ...
  /** @name FrameSupportWeightsRuntimeDbWeight (250) */
  ...
  /** @name OrmlVestingModuleError (257) */
  ...
  /** @name CumulusPalletXcmpQueueInboundChannelDetails (259) */
  ...
  /** @name CumulusPalletXcmpQueueInboundState (260) */
  ...
  /** @name PolkadotParachainPrimitivesXcmpMessageFormat (263) */
  ...
  /** @name CumulusPalletXcmpQueueOutboundChannelDetails (266) */
  ...
  /** @name CumulusPalletXcmpQueueOutboundState (267) */
  ...
  /** @name CumulusPalletXcmpQueueQueueConfigData (269) */
  ...
  /** @name CumulusPalletXcmpQueueError (271) */
  ...
  /** @name CumulusPalletXcmError (273) */
  export type CumulusPalletXcmError = Null;

  /** @name CumulusPalletDmpQueueConfigData (274) */
  export interface CumulusPalletDmpQueueConfigData extends Struct {
    readonly maxIndividual: u64;
  }

  /** @name CumulusPalletDmpQueuePageIndexData (275) */
  ...
  /** @name CumulusPalletDmpQueueError (278) */
  ...
  /** @name PalletUnqSchedulerScheduled (285) */
  export interface PalletUnqSchedulerScheduled extends Struct {
    readonly maybeId: Option<Bytes>;
    readonly priority: u8;
    readonly call: Call;
    readonly maybePeriodic: Option<ITuple<[u32, u32]>>;
    readonly origin: UniqueRuntimeOriginCaller;
    readonly preDispatch: UniqueRuntimeSchedulerPreDispatch;
  }

  /** @name UniqueRuntimeOriginCaller (286) */
  ...
  /** @name PalletEthereumRawOrigin (290) */
  ...
  /** @name UniqueRuntimeSchedulerPreDispatch (292) */
  export interface UniqueRuntimeSchedulerPreDispatch extends Struct {
    readonly tip: u128;
    readonly signer: AccountId32;
    readonly fee: Option<u128>;
  }

  /** @name PalletUnqSchedulerError (293) */
